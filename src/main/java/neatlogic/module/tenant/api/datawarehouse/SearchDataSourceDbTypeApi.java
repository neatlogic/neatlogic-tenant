...
//    private IntegrationMapper integrationMapper;
    ...
    public Object myDoService(JSONObject paramObj) throws Exception {
        ...
        List<IDataSourceServiceHandler> handlerList = DataSourceServiceHandlerFactory.getHandlerList();
        for (IDataSourceServiceHandler handler : handlerList) {
            JSONObject dataSourceTypeGroup = handler.getDataSourceTypeGroup(keyword);
            if (MapUtils.isNotEmpty(dataSourceTypeGroup)) {
                tbodyList.add(dataSourceTypeGroup);
            }
        }

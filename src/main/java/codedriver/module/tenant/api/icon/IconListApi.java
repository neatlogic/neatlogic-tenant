...
public class IconListApi extends PrivateApiComponentBase {
    ...
    public Object myDoService(JSONObject jsonObj) throws Exception {
        ...
        iconMap.put("cmdb", new String[]{"tsfont-cluster-mode", "tsfont-cluster-software", "tsfont-ip-list", "tsfont-db-cluster", "tsfont-net-area", "tsfont-userinfo", "tsfont-os-cluster", "tsfont-danger-level", "tsfont-retreat", "tsfont-app", "tsfont-ci-o", "tsfont-cluster", "tsfont-internet", "tsfont-db-ins", "tsfont-datacenter", "tsfont-component", "tsfont-ci", "tsfont-ip-object", "tsfont-ins", "tsfont-os", "tsfont-storages", "tsfont-softwareservice", "tsfont-group", "tsfont-mysql", "tsfont-adapter", "tsfont-dictionary", "tsfont-devices", "tsfont-auth", "tsfont-browser", "tsfont-eoa", "tsfont-hardware", "tsfont-certificate", "tsfont-debug", "tsfont-report", "tsfont-virtualmachine", "tsfont-pulse", "tsfont-version", "tsfont-location-o", "tsfont-lun", "tsfont-storm", "tsfont-netarea", "tsfont-port", "tsfont-f5", "tsfont-console", "tsfont-mm-misc", "tsfont-mm-rar", "tsfont-folder", "tsfont-folder-add", "tsfont-aix", "tsfont-apache", "tsfont-apple", "tsfont-alicloud", "tsfont-aws", "tsfont-centos", "tsfont-cisco", "tsfont-firewall", "tsfont-docker", "tsfont-freebsd", "tsfont-dell", "tsfont-hp", "tsfont-huawei", "tsfont-db2", "tsfont-java", "tsfont-ibm", "tsfont-hadoop", "tsfont-lighttpd", "tsfont-jboss", "tsfont-nginx", "tsfont-juniper", "tsfont-spark", "tsfont-inspur", "tsfont-linux", "tsfont-mesos", "tsfont-nutanix", "tsfont-redhat", "tsfont-openstack", "tsfont-techsure", "tsfont-windows", "tsfont-kafka", "tsfont-redis", "tsfont-zookeeper", "tsfont-tencentcloud", "tsfont-tomcat", "tsfont-postgresql", "tsfont-resin", "tsfont-vsphere"});
